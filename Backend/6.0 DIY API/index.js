...
app.post("/jokes", (req, res) => {
  ...
  jokes.push(newJoke);
  const latestJoke = jokes.slice(-1);
...
app.put("/jokes/:id", (req, res) => {
  ...
  //Replace Whole JS Array Object on PUT Request
...
app.patch("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = {
    id: id,
    //Whichever value is not null will be used
    jokeText : req.body.text || existingJoke.jokeText,
    jokeType : req.body.type || existingJoke.jokeType
  }

  //Replace Whole JS Array Object on PATCH Request
  const index = jokes.findIndex((joke) => joke.id === id);
  jokes[index] = replacementJoke;
